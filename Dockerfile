...
# use jfrog-artifactory-oss-<version. for version >= 4.0.0
ARG ARTIFACTORY_VERSION=artifactory-3.9.2
ARG ARTIFACTORY_SHA1=245aeb7b2d77830462067d5a19c3bd32ae014ddf
...
RUN \
  ...
  curl -L -o artifactory.zip https://dl.bintray.com/jfrog/artifactory/${ARTIFACTORY_VERSION}.zip && \
